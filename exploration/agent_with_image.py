...
class State(TypedDict):
    ...
    merged_md: str              # set by merge_content node
    md_with_placeholders: str   # set by decide_images node
    image_specs: List[dict]     # set by decide_images node
    # ── misc ──────────────────────────────────────────────
    as_of: str                  # date string e.g. "2026-04-01"
    recency_days: int           # how many days back research looks
    final: str                  # set by generate_and_place_images node
